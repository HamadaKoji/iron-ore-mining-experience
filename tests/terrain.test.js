...
framework.test('地形生成 - 正しいサイズ', function() {
    const terrain = TerrainGenerator.generateTerrain(0.2);
...
framework.test('地形生成 - 鉱石確率0%', function() {
    const terrain = TerrainGenerator.generateTerrain(0);
...
framework.test('地形生成 - 鉱石確率100%', function() {
    const terrain = TerrainGenerator.generateTerrain(1);
    const oreCount = TerrainGenerator.countOreAreas(terrain);
...
framework.test('鉱石エリアカウント', function() {
    ...
    terrain[1][1] = TERRAIN_TYPES.ORE;
    terrain[2][2] = TERRAIN_TYPES.ORE;
